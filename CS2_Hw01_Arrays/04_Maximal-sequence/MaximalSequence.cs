...
class MaximalSequence
{
    ...
    static void Main()
    {
        ...
        int[] testArray1 = { 2, 1, 1, 2, 3, 3, 2, 2, 2, 1 };
        char[] testArray2 = { '5', '5', '5', '2', '3', '0', '0', '0', '0', '0', '!' };
        bool[] testArray3 = { true, false, true, true, false, true, true, false, false, false, false, true, false };
        double[] testArray4 = { 1.1, 2.1, 3.1, 5.8, 5.8, 5.8, 4.1, 5.1, 2.0, 1.999999999999999999999999999, 2.000, 2.000000000000000035, 2.0000000000000000000000009 };
        decimal[] testArray5 = { 1.1m, 2.1m, 3.1m, 5.8m, 5.8m, 5.8m, 4.1m, 5.1m, 2.0m, 1.999999999999999999999999999m, 2.000m, 2.000000000000000035m, 2.0000000000000000000000009m };   //same values as in double array
        ...
        Console.WriteLine("Maximal equal elements sub-array {{ {0} }}", string.Join(", ", stats.subArray));
        ...
        {
            if (testArray3[i] == testArray3[i - 1])     //look behind
            {
                stats.currentLength++;
                if (stats.currentLength > stats.maxLength)
                {
